...
const ProjectsSection = () => {
  ...
  const projects = [
    ...
    {
      title: "Cricket Player Management Website",
      ...
      features: [
        "Record and analyze player performances across matches and tournaments.",
        "Visualize performance trends with graphs and stats.",
        "Add, edit, and organize team rosters.",
        "Maintain records of matches, scores, and highlights.",
        "Generate match reports with key insights.",
      ],
      liveLink: "https://dream-cricket-ph-10-a7.netlify.app",
      githubLink: "https://github.com/mdrakib02",
    },
  ];
